...
#define GRAPH
    ...
    CreateGraph("modelCNN",
        /* Arguments either passed or globals */
            CArgs(18,
                ...
                // in: 0.007812 out: 0.000031 NORM: 8
    ...
    // Node S2_Conv2d_32x1x3x3_MaxPool_2x2_Relu inq -1.00<i8*0.00781250<0.99 weightsq chan<i8*chan<chan outq -0.54<i8*0.00424822<0.54 biasesq i32*chan
    ...
    // Node S3_Conv2d_64x32x3x3_MaxPool_2x2_Relu inq -0.54<i8*0.00424822<0.54 weightsq chan<i8*chan<chan outq -0.31<i8*0.00243493<0.31 biasesq i32*chan
    ...
    // Node FULLY_CONNECTED_0_4 inq -0.31<i8*0.00243493<0.31 weightsq chan<i8*chan<chan outq -0.55<i8*0.00781250<0.55
    ...
    // Node SOFTMAX_0_5 inq 7 outq 15
